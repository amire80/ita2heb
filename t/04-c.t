...
say {$log} 'Acqua ' . Lingua::IT::Ita2heb::ita_to_heb('Acqua');
ok(
    Lingua::IT::Ita2heb::ita_to_heb('Acqua') eq "\N{HEBREW LETTER ALEF}"
        . "\N{HEBREW POINT PATAH}"
        . "\N{HEBREW LETTER QOF}"
        . "\N{HEBREW POINT DAGESH OR MAPIQ}"
...
say {$log} 'Volsci ' . Lingua::IT::Ita2heb::ita_to_heb('Volsci');
ok(
    Lingua::IT::Ita2heb::ita_to_heb('Volsci', disable_dagesh => 1) eq "\N{HEBREW LETTER VAV}"
        . "\N{HEBREW LETTER VAV}"
        . "\N{HEBREW POINT HOLAM}"
